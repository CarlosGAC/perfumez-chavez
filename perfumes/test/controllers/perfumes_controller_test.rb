...
class PerfumesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perfume" do
    assert_difference('Perfume.count') do
      post perfumes_url, params: { perfume: { buy_price: @perfume.buy_price, name: @perfume.name, retail_price: @perfume.retail_price, stock: @perfume.stock } }
    end
  ...
  test "should update perfume" do
    patch perfume_url(@perfume), params: { perfume: { buy_price: @perfume.buy_price, name: @perfume.name, retail_price: @perfume.retail_price, stock: @perfume.stock } }
